...
exports.getProfileOfInfluencer = (req, res) => {
    ...
    InfluencersData.findOne({ username: inputField })
        .select({ username: 1, _id: 0, edge_followed_by: 1, city_name: 1, category_enum: 1, full_name: 1, profile_pic_url_hd: 1, edge_felix_video_timeline: 1, edge_owner_to_timeline_media: 1, })
        .then((data) => {
            res.json(data)
        })
}